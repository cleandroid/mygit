...
public final class RecordService extends Service {
        ...
        public void handleMessage(Message msg) {
            if (resultCode == RESULT_OK) {
              ...
              //  startRecording(resultCode, data);
                ...
                Toast.makeText(getApplicationContext(), "resultCode == RESULT_NO", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        System.out.println("11111111111111111111111111 onStartCommand ");
       // System.out.println("11111111111111111111111111 onStartCommand "+RESULT_OK);
    ...
    private void startRecording(int resultCode, Intent data) {
        ...
        System.out.println("11111111111111111111111111 "+filePathAndName);
